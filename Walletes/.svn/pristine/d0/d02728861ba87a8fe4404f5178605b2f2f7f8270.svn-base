...
public class CustomKeyboard {
    ...
    public void setDelKeyboard(DelKeyboard delKeyboard) {
        this.delKeyboard = delKeyboard;
    }
    ...
    private DelKeyboard delKeyboard;
    ...
    private OnKeyboardActionListener mOnKeyboardActionListener = new OnKeyboardActionListener() {
        ...
        public final static int CodeCancel = -6; // Keyboard.KEYCODE_CANCEL
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            Log.i("ggband","onKeyDown:"+primaryCode);
...
//                    editable.delete(start - 1, start);
                if (delKeyboard != null)
                    delKeyboard.onDelKeyboard(edittext);
            } else { // insert character
                Log.i("ggband","插入值："+edittext.getId()+"="+Character.toString((char) primaryCode));
    ...
    public interface DelKeyboard {
        void onDelKeyboard(EditText rEditText);
    }
