    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                boolean moveDown = offsetY > 8;
                boolean moveUp = offsetY < -8;
                ...
                boolean canFooterMoveUp = mPtrHandler != null && mFooterView != null // The footer view could be null, so need double check
                        && mPtrHandler instanceof PtrHandlerWithLoadMore && ((PtrHandlerWithLoadMore) mPtrHandler).checkCanDoLoadMore(this, mContent, mFooterView) && (mMode.ordinal() & 2) > 0;
    ...
    private void performRefresh() {
        ...
        if (mPtrHandler != null) {
            if (mPtrIndicator.isHeader()) {
                ...
                if (mPtrHandler instanceof PtrHandlerWithLoadMore) {
                    ((PtrHandlerWithLoadMore) mPtrHandler).onLoadMoreBegin(this);
                }
            }
        }
    }
