...
public class SetActivity extends BaseSwipeActivity {
    ...
    @OnClick({R.id.tv_zl, R.id.tv_exit, R.id.tv_aq, R.id.tv_chache, R.id.tv_hp})
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_exit:
                ...
                builder.setTitle("提示")
                        .setMessage("确定退出吗")
                        .setPositiveButton("确定", diaListener)
                        .setNegativeButton("取消", diaListener)
                        .show();
...
//                    ActivityManager.getScreenManager().popAllActivityExceptOne(LogingActivity.class);
                    break;
