...
public class WalletLoanLog {
    ...
    public float getTotalMoner() {
        return Float.parseFloat(reimbursement)+mayBorrowMoney;
    }
    ...
    public int getMayBorrowMoney() {
        return mayBorrowMoney;
    }

    public void setMayBorrowMoney(int mayBorrowMoney) {
