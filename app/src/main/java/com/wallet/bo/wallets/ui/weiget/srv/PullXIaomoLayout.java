...
public class PullXIaomoLayout extends PtrFrameLayout {

    private PtrClassicDefaultXiaomoHeader mPtrClassicHeader;
    private PtrClassicDefaultFooter mPtrClassicFooter;

    public PullXIaomoLayout(Context context) {
        super(context);
        initViews();
    }

    public PullXIaomoLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews();
    }

    public PullXIaomoLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initViews();
    }

    private void initViews() {
        mPtrClassicHeader = new PtrClassicDefaultXiaomoHeader(getContext());
    ...
    public PtrClassicDefaultXiaomoHeader getHeader() {
