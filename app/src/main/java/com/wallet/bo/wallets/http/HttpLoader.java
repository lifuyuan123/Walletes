...
public class HttpLoader extends ObjectLoader implements IHttpLoader {
    ...
    @Override
    public void returnFace(Map<String, String> stringMap, ApiBaseResponseCallback<UserInfo> callBack) {
    ...
    @Override
    public void loanrepa(String uid, ApiBaseResponseCallback<LoanRepayBean> callBack) {
        observe(apiStores.loanrepa(uid)).subscribe(callBack);
    }

    @Override
    public void UserMenuManagement(Map<String, String> stringMap, ApiBaseResponseCallback<String> callBack) {
        observe(apiStores.UserMenuManagement(requestHelpr.getRequestParm(stringMap))).subscribe(callBack);

    }


    @Override
    public void upMaillist(Map<String, String> stringMap, ApiBaseResponseCallback<String> callBack) {
        observe(apiStores.upMaillist(requestHelpr.getRequestParm(stringMap))).subscribe(callBack);

    }


    @Override
    public void WithdrawalPageData(Map<String, String> stringMap, ApiBaseResponseCallback<WithdrawalsBean> callBack) {
        observe(apiStores.WithdrawalPageData(requestHelpr.getRequestParm(stringMap))).subscribe(callBack);
    }

    @Override
    public void UserWithdrawal(Map<String, String> stringMap, ApiBaseResponseCallback<String> callBack) {
        observe(apiStores.UserWithdrawal(requestHelpr.getRequestParm(stringMap))).subscribe(callBack);
    }


    @Override
    public void getAppGraph( ApiBaseResponseCallback<List<GuideBean>> callBack) {
        observe(apiStores.getAppGraph()).subscribe(callBack);
    }


    @Override
    public void GetUserGrade(Map<String, String> stringMap, ApiBaseResponseCallback<VipBeans> callBack) {
        observe(apiStores.GetUserGrade(requestHelpr.getRequestParm(stringMap))).subscribe(callBack);
    }

    @Override
    public void checkUserRefundable(Map<String, String> stringMap, ApiBaseResponseCallback<RefundBean> callBack) {
        observe(apiStores.checkUserRefundable(requestHelpr.getRequestParm(stringMap))).subscribe(callBack);
    }

    @Override
    public void AndroidOrIosUserCharge(Map<String, String> stringMap, ApiBaseResponseCallback<PayOrder> callBack) {
        observe(apiStores.AndroidOrIosUserCharge(requestHelpr.getRequestParm(stringMap))).subscribe(callBack);
    }
