...
public class DefaultLoadingLayout extends SmartLoadingLayout {
    ...
    DefaultLoadingLayout(Context context, View contentView) {
        ...
        this.mInflater = LayoutInflater.from(context);
        {
            ...
            mNoNetView = mInflater.inflate(R.layout.smartloadinglayout_view_on_nonet, null);
    ...
    public void setNonetButtonListener(View.OnClickListener listener) {
        if (btnNonetHandle == null)
            btnNonetHandle = (Button) mNoNetView.findViewById(R.id.btn_nonet);

        btnNonetHandle.setOnClickListener(listener);
    }
    ...
    public void onNonet() {
        ...
        if (!mNoNetAdded) {
            ...
            if (mNoNetView != null) {
                rlAddedView.addView(mNoNetView, mLayoutParams);
                mNoNetAdded = true;
            }
        }
        dtvLoading.hideAndStop();
        showViewWithStatus(LayoutStatus.NoNet);

        setNonetButtonListener(new View.OnClickListener() {
            @Override
